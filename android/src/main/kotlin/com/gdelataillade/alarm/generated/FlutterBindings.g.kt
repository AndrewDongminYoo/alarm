...
enum class AlarmErrorCode(
    ...
    companion object {
        fun ofRaw(raw: Int): AlarmErrorCode? = values().firstOrNull { it.raw == raw }
    }
}
...
interface AlarmApi {
    ...
    fun setWarningNotificationOnKill(
        title: String,
        body: String,
    )
        ...
        fun setUp(
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.alarm.AlarmApi.setAlarm$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.alarm.AlarmApi.stopAlarm$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.alarm.AlarmApi.stopAll$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.alarm.AlarmApi.isRinging$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.alarm.AlarmApi.setWarningNotificationOnKill$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { message, reply ->
            ...
            run {
                val channel =
                    BasicMessageChannel<Any?>(
                        binaryMessenger,
                        "dev.flutter.pigeon.alarm.AlarmApi.disableWarningNotificationOnKill$separatedMessageChannelSuffix",
                        codec,
                    )
                if (api != null) {
                    channel.setMessageHandler { _, reply ->
