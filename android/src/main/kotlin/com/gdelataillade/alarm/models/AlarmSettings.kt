    ...
    companion object {
        ...
        fun fromJson(json: String): AlarmSettings {
            ...
            val notificationSettings =
                jsonObject["notificationSettings"]?.let {
            ...
            val warningNotificationOnKill =
                jsonObject.primitiveBoolean("warningNotificationOnKill")
                    ?: throw SerializationException("Missing 'warningNotificationOnKill'")
            val androidFullScreenIntent =
                jsonObject.primitiveBoolean("androidFullScreenIntent")
