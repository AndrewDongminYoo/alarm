...
class AlarmSettings extends Equatable {
  ...
  factory AlarmSettings.fromJson(Map<String, dynamic> json) {
    ...
    if (!json.containsKey('volumeSettings')) {
      ...
      final fadeDurationMillis = (fadeDurationSeconds != null && fadeDurationSeconds > 0)
  ...
  AlarmSettings copyWith({
    ...
    return AlarmSettings(
      ...
      androidStopAlarmOnTermination: androidStopAlarmOnTermination ?? this.androidStopAlarmOnTermination,
