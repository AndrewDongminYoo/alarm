...
class VolumeFadeStep extends Equatable {
  ...
  factory VolumeFadeStep.fromJson(Map<String, dynamic> json) => _$VolumeFadeStepFromJson(json);
  ...
  /// Converts to wire datatype which is used for host platform communication.
  VolumeFadeStepWire toWire() => VolumeFadeStepWire(timeMillis: time.inMilliseconds, volume: volume);
